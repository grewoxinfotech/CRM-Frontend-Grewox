...
import { Card, Typography, List, Tag, Space, Button, Empty, Skeleton, message, Progress, Divider, Input, Avatar, Tooltip } from "antd";
...
const LeadAI = ({ leadId, leadData }) => {
    ...
    if (typeof content === 'object') {
      ...
      const sourceHint =
        normalizedSource === "mixed"
          ? "Part of this reply came from AI, and part was completed by fallback logic. AI responses may not always be 100% complete."
          : normalizedSource === "fallback"
            ? "This reply was generated by fallback logic because AI output was incomplete. AI responses are not guaranteed to be perfect every time."
            : "This reply came directly from AI. Even then, AI output may not be 100% perfect, so review before sending.";

      return (
        <div className="ai-bot-response-card">
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
            <div style={{ fontWeight: 600, color: "#1e293b", marginBottom: "4px" }}>💡 Strategy</div>
            <Tooltip title={sourceHint}>
              <Tag color={sourceColor} style={{ marginRight: 0, cursor: "help" }}>
                {sourceLabel}
              </Tag>
            </Tooltip>
          </div>
  ...
  return (
    <div className="lead-ai-overview">
      <Card
        title={
          <Space>
