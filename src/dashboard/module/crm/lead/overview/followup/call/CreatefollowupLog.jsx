...
import { FiX, FiCalendar, FiPhone, FiUser, FiShield, FiBriefcase, FiUserPlus } from 'react-icons/fi';
...
const CreateLog = ({ open, onCancel, onSubmit, initialDate, initialTime, leadId }) => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      const assignedTo = values.assigned_to ? values.assigned_to.map(id => String(id)) : [String(currentUser?.id)];
