        ...
        >
            ...
            >
                ...
                <div style={{ 
                    ...
                    <Form.Item
                        name="leadStage"
                        label={<span style={{ fontSize: '14px', fontWeight: '500' }}>Lead Stage</span>}
                    >
                        <Select
                    ...
                    <Form.Item
                        name="leadValue"
                        label={<span style={{ fontSize: '14px', fontWeight: '500' }}>Lead Value</span>}
                    >
                        <Input
                    ...
                    <Form.Item
                        name="telephone"
                        label={<span style={{ fontSize: '14px', fontWeight: '500' }}>Telephone</span>}
                    >
                        <Input
                    ...
                    <Form.Item
                        name="assigned"
                        label={<span style={{ fontSize: '14px', fontWeight: '500' }}>Assigned To</span>}
                    >
                        <Select
                    ...
                    <Form.Item
                        name="lead_members"
                        label={<span style={{ fontSize: '14px', fontWeight: '500' }}>Lead Members</span>}
                    >
                        <Select
                            mode="multiple"
                    ...
                    <Form.Item
                        name="source"
                        label={<span style={{ fontSize: '14px', fontWeight: '500' }}>Source</span>}
                    >
                        <Select
                    ...
                    <Form.Item
                        name="tags"
                        label={<span style={{ fontSize: '14px', fontWeight: '500' }}>Tags</span>}
                    >
                        <Select
                            mode="tags"
                    ...
                    <Form.Item
                        name="files"
                        label={<span style={{ fontSize: '14px', fontWeight: '500' }}>Files</span>}
                    >
                        <Select
                            mode="multiple"
                    ...
                    <Form.Item
                        name="company_name"
                        label={<span style={{ fontSize: '14px', fontWeight: '500' }}>Company Name</span>}
                    >
                        <Input
