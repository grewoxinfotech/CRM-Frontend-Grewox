...
import { Modal, Form, Input, Button, Typography, Select, Row, Col, Divider, DatePicker, Upload, message } from 'antd';
import { FiFileText, FiX, FiCalendar, FiUser, FiHash, FiUpload, FiBriefcase, FiCreditCard, FiTag, FiDollarSign } from 'react-icons/fi';
...
const CreateCreditNotes = ({ open, onCancel, onSubmit }) => {
