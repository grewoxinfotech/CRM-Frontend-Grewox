...
import { Modal, Form, Input, Button, Typography, Select, Row, Col, Divider, InputNumber, DatePicker, Space } from 'antd';
...
const CreateInvoice = ({ open, onCancel, onSubmit }) => {
    ...
    const handleSubmit = async (values) => {
        try {
            ...
            formData.append('sub_total', values.sub_total || 0);
            formData.append('item_discount', values.item_discount || 0);
            formData.append('total_tax', values.total_tax || 0);
            formData.append('total_amount', values.total_amount || 0);
                ...
                <Row gutter={16}>
                    <Col span={12}>
                        ...
                        >
                            ...
                            >
                                <Option value="1">John Doe Enterprises</Option>
                    ...
                    {(fields, { add, remove }) => (
                        <>
                            <div style={{ marginBottom: '16px' }}>
                                <Row gutter={16} style={{ padding: '12px 0', borderBottom: '1px solid #e6e8eb' }}>
                                    <Col span={6}><Text strong>Item*</Text></Col>
                                    <Col span={3}><Text strong>Quantity*</Text></Col>
                                    <Col span={4}><Text strong>Unit Price*</Text></Col>
                                    <Col span={4}><Text strong>HSN/SAC</Text></Col>
                                    <Col span={3}><Text strong>Discount</Text></Col>
                                    <Col span={2}><Text strong>TAX (%)</Text></Col>
                                    <Col span={2}><Text strong>Amount</Text></Col>
                                </Row>
                            </div>

                            {fields.map(({ key, name, ...restField }, index) => (
                                <div key={key} style={{ marginBottom: '16px', padding: '16px', backgroundColor: '#f8fafc', borderRadius: '8px' }}>
                                    <Row gutter={16}>
                                        <Col span={6}>
                                            <Form.Item
                                                {...restField}
