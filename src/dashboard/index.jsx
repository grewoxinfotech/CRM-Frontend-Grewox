...
import { Avatar, Card, Row, Col, Button, Typography, Space, Badge, Dropdown } from 'antd';
import {
    EditOutlined,
    SettingOutlined,
    UserOutlined,
            ...
            <Row className="dashboard-header" justify="end" align="middle">
                ...
                >
                    <Avatar
                        size={40}
                        src={user?.profilePic}
                        style={{ cursor: 'pointer', backgroundColor: user?.profilePic ? 'transparent' : '#1890ff' }}
                    >
                        ...
                        <div className="profile-content">
                            <Badge dot status="success" offset={[-5, 85]}>
                                <Avatar
                                    size={120}
                                    src={user?.profilePic}
                                    style={{ backgroundColor: user?.profilePic ? 'transparent' : '#1890ff' }}
                                >
                                    {!user?.profilePic && getInitials(getUserFullName())}
                                </Avatar>
                            </Badge>
