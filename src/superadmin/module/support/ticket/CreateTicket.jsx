...
const CreateTicket = ({ open, onCancel, isEditing, initialValues, isSupport = false }) => {
    ...
    // Case-insensitive check for super-admin role
    const isSuperAdmin = userRole?.toLowerCase() === 'super-admin' || userRole?.toLowerCase() === 'super admin';
    const isSimplified = isSupport && !isSuperAdmin;
